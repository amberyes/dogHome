...
<center><h1>更改密码</h1></center>
<div class="ver-info">
    <div class="pp-1">
        <s:form action="cham" method="post">
            <table>
                ...
                <div class="m-b">
                    <input type="password" name="user.password" placeholder="请输入更改的密码" maxlength="16" class="bg-white text" >
                </div>
                <div class="grid m-b">
                    <div class="grid-cell">
                        <input type="submit" value="确定" class="p-code text t-center"   >
