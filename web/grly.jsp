...
<s:form action="deletely" method="post" enctype="multipart/form-data" >
    <table>
        <tr>
            <td>选择编号:</td>
            <td><input type="text" name="lyer.id" /></td><td><input type="submit" value="删除"/></td>
        </tr>
