    ...
    <div class="pp-1">
        <s:form action="registeraction" method="post">
            <table>
                ...
                <div class="m-b">
                    <input type="password" name="user.password" placeholder="请输入密码" maxlength="16" class="bg-white text" >
                </div>
                <div class="m-b">
                    <input type="text" name="user.email" placeholder="请输入邮箱" maxlength="22" class="bg-white text" >
                </div>
                <div class="m-b">
                    <input type="text" name="user.tel" placeholder="请输入电话" maxlength="16" class="bg-white text" >
                </div>
                <div class="grid m-b">
                    <div class="grid-cell">
                        <input type="submit" value="注册" class="p-code text t-center"   >
